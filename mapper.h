...
public:
  ...
  */
  void creade_reduction_instance(const Legion::Mapping::MapperContext ctx,
    ...
    bool res =default_create_custom_instances(ctx,
                  task.target_proc,
                  target_mem,
                  task.regions[indx],
                  indx,
  ...
  */
  void create_compacted_instance(const Legion::Mapping::MapperContext ctx,
    ...
    size_t instance_size = 0;
    auto res=runtime->find_or_create_physical_instance(ctx, target_mem,
  ...
  */
  void create_instance(const Legion::Mapping::MapperContext ctx,
    ...
    size_t instance_size = 0;
    bool res = runtime->find_or_create_physical_instance(ctx, target_mem,
